...
function InfoResponsibility() {
    const { t, i18n } = useTranslation()

    return(
        <div id="directions" className={styles.container}>
            <p className={styles.text}>{t('responsibilities.details')}</p>
            <p className={styles.text} style={{fontWeight: 'bold'}}>{t('responsibilities.guarantee')}</p>
        </div>
    )
}
